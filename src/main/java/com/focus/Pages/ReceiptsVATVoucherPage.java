...
private static List<WebElement> masterItemsList;
	...
	private static WebElement CancelBtn; 
	  ...
	  public static WebElement standardRateDeleteRow1;
		...
		public boolean checkSavingSalesInvoiceVoucher1WithCustomerAccountAsCustomerNewReference() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(finacinalsMenu));
			finacinalsMenu.click();
		...
		public boolean checkSavingSalesInvoiceVoucher2WithCustomerAccountAsCustomerSemiAdjustment() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customerAccountTxt));
			customerAccountTxt.click();
		...
		public boolean checkSavingSalesInvoiceVoucher3WithCustomerAccountAsCustomerFullAdjustment() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
		{
			getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customerAccountTxt));
			customerAccountTxt.click();
			customerAccountTxt.sendKeys("Customer Full Adjustment");
			Thread.sleep(3000);
			customerAccountTxt.sendKeys(Keys.TAB);
