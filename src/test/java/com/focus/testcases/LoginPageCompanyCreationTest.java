...
public class LoginPageCompanyCreationTest extends BaseEngine {
	...
	private static String getCompanyInfo;
	  ...
	  @Test(priority=9)//Minimize and Maximize
	  ...
	  @Test(priority=26)
	  public void verifyLogoutAfterCreateCompanyAndSignIn() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	  {
		  LoginPage lp=new LoginPage(getDriver());
