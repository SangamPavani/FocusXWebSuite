...
public class LoginPage extends BaseEngine 
{
   ...
   private static WebElement noIn;
	...
	@FindBy(xpath="//*[@id='id_mainlayoutmenu']/ul[2]/li[6]/div/ul/li[1]/a")
	private static WebElement changePassword;
 ...
 public static boolean checkBrowserIsOpen() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
 {
  ...
  public static boolean checkLoginPageTitleByURLInputInBrowser() throws EncryptedDocumentException, InvalidFormatException, IOException 
  {
    ...
    // Home Menu
	 ...
	 public static boolean checkLogoutAfterCompanyCreationSignIn() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
    ...
    public static boolean verifyUserHomePageAndDashBoard() throws InterruptedException
    {
	 ...
	 public static boolean checkRememberMeAsCheckedInLoginPage() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		...
		boolean actRememberMe = rememberMeChkBox.isSelected();
		boolean expREmemberMe = true;
		
		System.out.println("actRememberMe"+actRememberMe);
		System.out.println("expREmemberMe"+expREmemberMe);
	 ...
	 public static boolean checkRememberMeSignIn() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	 {
		...
		xlfile=getBaseDir()+"\\src\\main\\resources\\testdata\\FocusTestData.xlsx";
         ...
         reLogin(unameltR, pweltR, "Automation Company");
		...
		Thread.sleep(2000);	*/
		 ...
		 System.out.println("actchangePassword "+actchangePassword);
		 System.out.println("expchangePassword "+expchangePassword);
		 
		 boolean actchangePasswordisEnabled = changePassword.isDisplayed();
		 boolean expchangePasswordisEnabled = true;
		 
		 System.out.println("actchangePasswordisEnabled "+actchangePasswordisEnabled);
		 System.out.println("expchangePasswordisEnabled "+expchangePasswordisEnabled);
	 ...
	 public static boolean checkRememeberMeRememberSelected() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	   {
		...
		xlfile=getBaseDir()+"\\src\\main\\resources\\testdata\\FocusTestData.xlsx";
		 ...
		 boolean actrememberMeChk = rememberMeChkBox.isDisplayed();
		 boolean exprememberMeChk = true;
		 
		 System.out.println("actrememberMeChk "+actrememberMeChk);
		 System.out.println("exprememberMeChk "+exprememberMeChk);
		 
		 boolean actrememberPwdChk = rememberPwdChkBox.isDisplayed();
		 boolean exprememberPwdChk = true;
		 
		 System.out.println("actrememberPwdChk "+rememberPwdChk);
		 System.out.println("exprememberPwdChk "+rememberPwdChk);
		 
		 Thread.sleep(3000);
		 
		 if(rememberMeChkBox.isSelected() && rememberPwdChkBox.isSelected())
		 {
