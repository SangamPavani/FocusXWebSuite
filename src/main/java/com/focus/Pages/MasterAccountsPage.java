...
public class MasterAccountsPage extends BaseEngine
{
	    //Home Menu
			...
			//Master Left panel----TreeID-----Elements
								...
								@FindBy(xpath="//h5[contains(text(),'Create Tree')]")
								...
								@FindBy(xpath="//*[@id='MasterTreeTable_col_1-1']")
			...
			//TreeViewID----->Elements
									...
									public static WebElement CreateView_CreateViewTxt; 
										...
										@FindBy(xpath="//*[@id='1104_0_AdvanceFilter_']/table/tbody/tr/td[1]/select")
										public static WebElement CreateView_Conjuction1Dropdown; 
						/////////
										@FindBy(xpath="//*[@id='1104_0_AdvanceFilter_']/table/tbody/tr/td[2]/input")
										public static WebElement CreateView_AccountType1Dropdown; 
										                      
										@FindBy(xpath="//*[@id='1104_0_AdvanceFilter_']/table/tbody/tr/td[3]/select")
										public static WebElement CreateView_EqaulTo1Dropdown; 
										
										@FindBy(xpath="//*[@id='1104_0_AdvanceFilter_']/table/tbody/tr/td[4]/select")
		   ...
		   //Master------>Delete Field
			...
			@FindBy(xpath="//a[contains(text(),'Tree Tab Delete')]")
			...
			@FindBy(xpath="//*[@id='MCustomize_DeleteTab_Modal']/div[2]/div/div[3]/div/div/input[1]")
			public static WebElement  CustomizeDeleteTabMessageYesBtn;

			@FindBy(xpath="//*[@id='MCustomize_DeleteTab_Modal']/div[2]/div/div[3]/div/div/input[2]")
		 ...
		 @FindBy(xpath="(//*[@id='example']/tbody/tr[1]/td[text()='Extra Field One'])[1]")
		 public static WebElement extraFields_CreatedByUserInHeaderDetailsTab;
				 
		 @FindBy(xpath="(//i[@data-fieldid='305829'])[1]")
		 ...
		 @FindBy(xpath="(//i[@data-fieldid='305829'])[2]")
...
*/		/* boolean actmastercustamizeTreeBtn    	 	  =mastercustamizeTreeBtn.isDisplayed();*/
	...
	/*	 boolean actmasterBudgetBtn    	 		      =masterBudgetBtn.isDisplayed();*/
		...
		/* System.out.println("masterBudgetBtn                    : "+actmasterBudgetBtn                    +" Value Expected : "+expmasterBudgetBtn);*/
		 ...
		 if(actmasterCustamizemasterBtn==expmasterCustamizemasterBtn /*&& actmasterCustamizeViewBtn==expmasterCustamizeViewBtn  */
				 && actmasterLedgerBtn==expmasterLedgerBtn&& actmasterManageCreditBtn==expmasterManageCreditBtn && actmasterDepartmentAppropriationBtn==expmasterDepartmentAppropriationBtn
	...
	public static boolean checkCreateViewToggleOptionsAccountsMenu() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		 ...
		 getAction().moveToElement(masterTreeViewIDToggleBtn).build().perform();
	...
	public static boolean checkValidationHideAccountGroupsOptionsAccountsMenuBySelectingNewBtn() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		/* getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterOptionToHideAccountsGroupTree));	
		 ...
		 ClickUsingJs(masterOptionToHideAccountsGroupTree);
		 
		 boolean actaccountAssestsGroup = false;
		 
		 boolean expaccountAssestsGroup = false;
		 
		 try {
			 
			 if(accountAssestsGroup.isDisplayed()==false)
			 {
				  actaccountAssestsGroup  =accountAssestsGroup.isDisplayed();
				  expaccountAssestsGroup  =false;
			 }
		 ...
		 boolean actaccountAssestsGroupUnhide  =accountAssestsGroup.isDisplayed();
		 boolean expaccountAssestsGroupUnhide  =true;
		 
		 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterNewCloseBtn));	
		 masterNewCloseBtn.click();
		...
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterSideBarSettingsBtn));
		boolean actMasterSideBarSettingsBtn= masterSideBarSettingsBtn.isDisplayed();
		boolean expMasterSideBarSettingsBtn=true;
		
		boolean actMasterSideBarEditBtn= masterSideBarEditBtn.isDisplayed();
		boolean expMasterSideBarEditBtn=true;
		
		boolean actMasterSideBarCloseBtn= masterSideBarCloseBtn.isDisplayed();
		boolean expMasterSideBarCloseBtn=true;
		
 System.out.println("*********************************checkUnHideAccountGroupsOptionsAccountsMenu*****************************************");
		 
		 System.out.println("accountAssestsGroup  : "+actaccountAssestsGroup+" Value Expected : "+expaccountAssestsGroup);
		 System.out.println("accountAssestsGroupUnhide  : "+actaccountAssestsGroupUnhide+" Value Expected : "+expaccountAssestsGroupUnhide);
		 
		 System.out.println("*********************************checkMasterSideBarAccountsMenu*****************************************");
		 System.out.println("Side Bar Settings Btn  : "+actMasterSideBarSettingsBtn+" Value Expected : "+expMasterSideBarSettingsBtn);
		 System.out.println("Side Bar Edit Btn  : "+actMasterSideBarEditBtn+" Value Expected : "+actMasterSideBarEditBtn);
		 System.out.println("Side Bar Close Btn  : "+actMasterSideBarCloseBtn+" Value Expected : "+expMasterSideBarCloseBtn);
		 
		 if(actaccountAssestsGroup==expaccountAssestsGroup && actaccountAssestsGroupUnhide==expaccountAssestsGroupUnhide
				 && actMasterSideBarSettingsBtn==expMasterSideBarSettingsBtn &&actMasterSideBarEditBtn== expMasterSideBarEditBtn  
				 && actMasterSideBarCloseBtn== expMasterSideBarCloseBtn)
		 {	
			 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterSideBarCloseBtn));
			 masterSideBarCloseBtn.click();
...
//		boolean expitemInfoPanelCustomizationTab               =true;
	...
	/*public static boolean checkSettingsTabHeaderFieldsInCustomizeMaster() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		boolean actaccountSettingsHeaderEditEighthRowBtn   =accountSettingsHeaderEditEighthRowBtn.isDisplayed();1
    ...
    public static boolean checkHeaderFieldsUniqueContraintCustomizeMaster() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	if(UniqueConstraints_Header_ChequeDiscountLimitChekbox.isDisplayed()==false)
    	{
    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(UniqueConstraints_HeaderExpansionBtn));
        	UniqueConstraints_HeaderExpansionBtn.click();
        	Thread.sleep(2000);
    ...
    public static boolean checkOkEditPopUpForNewCreateTreeTabDisplayInTabs() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTreeTabNewlyCreateOkButton));
    	customizeMasterCreateTreeTabNewlyCreateOkButton.click();
    ...
    /*	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTreeTabNewlyHeaderDetails));
    	...
    	*/
    	...
    	System.out.println("1CustomizeDeleteTabMessage  : "+actCustomizeDeleteTabMessage+" Value Expected : "+expCustomizeDeleteTabMessage);
    ...
    public static boolean checkCreateCreateTabDisplayInCustomizeTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	excelReader=new ExcelReader(POJOUtility.getExcelPath());
   	    ...
   	    getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateCreateTabNewlyCreateTab));
   	    
   	    boolean actcustomizeMasterCreateCreateTabNewlyCreateTab  =customizeMasterCreateCreateTabNewlyCreateTab.isDisplayed();
		boolean expcustomizeMasterCreateCreateTabNewlyCreateTab  =true;
		
		System.out.println("***************************checkCreateCreateTabDisplayInCustomizeTab***********************");
		
		System.out.println("customizeMasterCreateCreateTabNewlyCreateTab : "+actcustomizeMasterCreateCreateTabNewlyCreateTab+" Value Expected : "+expcustomizeMasterCreateCreateTabNewlyCreateTab);
           
   	    if(actcustomizeMasterCreateCreateTabNewlyCreateTab==expcustomizeMasterCreateCreateTabNewlyCreateTab)
   	    {
    ...
    public static boolean checkHeaderDetailsTabInCreateCreateTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	Thread.sleep(3000);
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateCreateTabNewlyCreateTab));
    	customizeMasterCreateCreateTabNewlyCreateTab.click();
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTabHeaderDetails));
 	   	
    	boolean actcustomizeMasterCreateTabHeaderDetails  			=customizeMasterCreateTabHeaderDetails.isDisplayed();
    	boolean actcustomizeMasterCreateTabBlankHeaderDetails  		=customizeMasterCreateTabBlankHeaderDetails.isDisplayed();
    	boolean actcustomizeMasterCreateTabNewlyCreateTabSaveButton   =customizeMasterCreateTabNewlyCreateTabSaveButton.isDisplayed();
    	boolean actcustomizeMasterCreateTabAddButton  				=customizeMasterCreateTabAddButton.isDisplayed();
    	boolean actcustomizeMasterCreateTabPreviewButton  			=customizeMasterCreateTabPreviewButton.isDisplayed();
    	boolean actcustomizeMasterCreateTabCloseButton  				=customizeMasterCreateTabCloseButton.isDisplayed();
    	
    	boolean expcustomizeMasterCreateTabHeaderDetails  			=true;
    	boolean expcustomizeMasterCreateTabBlankHeaderDetails  		=true;
    	boolean expcustomizeMasterCreateTabNewlyCreateTabSaveButton   =true;
    	boolean expcustomizeMasterCreateTabAddButton  				=true;
    	boolean expcustomizeMasterCreateTabPreviewButton  			=true;
    	boolean expcustomizeMasterCreateTabCloseButton  				=true;
    	
    	System.out.println("***************************************************checkHeaderDetailsTabInCreateCreateTab****************************************");
    	
    	System.out.println("customizeMasterCreateTabHeaderDetails             : "+actcustomizeMasterCreateTabHeaderDetails            +" Value Expected : "+expcustomizeMasterCreateTabHeaderDetails);
    	System.out.println("customizeMasterCreateTabHeaderDetails        : "+actcustomizeMasterCreateTabBlankHeaderDetails       +" Value Expected : "+expcustomizeMasterCreateTabBlankHeaderDetails);
    	System.out.println("customizeMasterCreateTabNewlyCreateTabSaveButton  : "+actcustomizeMasterCreateTabNewlyCreateTabSaveButton +" Value Expected : "+expcustomizeMasterCreateTabNewlyCreateTabSaveButton);
    	System.out.println("customizeMasterCreateTabAddButton                 : "+actcustomizeMasterCreateTabAddButton                +" Value Expected : "+expcustomizeMasterCreateTabAddButton);
    	System.out.println("customizeMasterCreateTabPreviewButton             : "+actcustomizeMasterCreateTabPreviewButton            +" Value Expected : "+expcustomizeMasterCreateTabPreviewButton);
    	System.out.println("customizeMasterCreateTabCloseButton               : "+actcustomizeMasterCreateTabCloseButton              +" Value Expected : "+expcustomizeMasterCreateTabCloseButton);
    	
    	if(actcustomizeMasterCreateTabHeaderDetails==expcustomizeMasterCreateTabHeaderDetails
    			&& actcustomizeMasterCreateTabBlankHeaderDetails==expcustomizeMasterCreateTabBlankHeaderDetails
    			&& actcustomizeMasterCreateTabNewlyCreateTabSaveButton==expcustomizeMasterCreateTabNewlyCreateTabSaveButton
    			&& actcustomizeMasterCreateTabAddButton==expcustomizeMasterCreateTabAddButton
    			&& actcustomizeMasterCreateTabPreviewButton==expcustomizeMasterCreateTabPreviewButton
    			&& actcustomizeMasterCreateTabCloseButton==expcustomizeMasterCreateTabCloseButton)
    	{
    ...
    public static boolean checkBodyDetailsTabInCreateCreateTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTabBodyDetails));
    	customizeMasterCreateTabBodyDetails.click();
             
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTabBodyDetails));
             
    	boolean actcustomizeMasterCreateTabBodyDetails       =customizeMasterCreateTabBodyDetails.isDisplayed();
    	boolean actcustomizeMasterCreateTabBlankBodyDetails  =customizeMasterCreateTabBlankBodyDetails.isDisplayed();
    	
    	boolean expcustomizeMasterCreateTabBodyDetails       =true;
    	boolean expcustomizeMasterCreateTabBlankBodyDetails  =true;
    	
    	System.out.println("customizeMasterCreateTabBodyDetails       : "+actcustomizeMasterCreateTabBodyDetails      +" Value Expected : "+expcustomizeMasterCreateTabBodyDetails);
    	System.out.println("customizeMasterCreateTabBlankBodyDetails  : "+actcustomizeMasterCreateTabBlankBodyDetails +" Value Expected : "+expcustomizeMasterCreateTabBlankBodyDetails);

    	if(actcustomizeMasterCreateTabBodyDetails==expcustomizeMasterCreateTabBodyDetails
    			&& actcustomizeMasterCreateTabBlankBodyDetails==expcustomizeMasterCreateTabBlankBodyDetails)
    	{
    ...
    public static boolean checkAddOptionInCreateCreateTabDisplayInCustomizeTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTabHeaderDetails));
    	customizeMasterCreateTabHeaderDetails.click();
             
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(customizeMasterCreateTabAddButton));
    	customizeMasterCreateTabAddButton.click();
    ...
    public static boolean checkCloseButtonWithInputMandatoryFieldsCreateCreateTabDisplayInCustomizeTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	Thread.sleep(1000);
    	customizeMasterCreateTabCloseButton.click();
    	...
    	if(actcustomizeMasterCreateTabHeaderDetails==expcustomizeMasterCreateTabHeaderDetails
    			&& actcustomizeMasterCreateTabHeaderDetails==expcustomizeMasterCreateTabHeaderDetails
    			&& actcustomizeMasterCreateTabNewlyCreateTabSaveButton==expcustomizeMasterCreateTabNewlyCreateTabSaveButton
    			&& actcustomizeMasterCreateTabAddButton==expcustomizeMasterCreateTabAddButton
    			&& actcustomizeMasterCreateTabPreviewButton==expcustomizeMasterCreateTabPreviewButton
    			&& actcustomizeMasterCreateTabCloseButton==expcustomizeMasterCreateTabCloseButton)
    ...
    public static boolean checkOkButtonInMoveField() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createTabSaveTab));
    	createTabSaveTab.click();
    	
    	
    	String expMessage="Master updated successfully";
    	...
    	if(actMessage.equalsIgnoreCase(expMessage))
    	{
    		...
    		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(createTabCloseBtn));
    		createTabCloseBtn.click();
    ...
    public static boolean checkMoveFieldMovedToSettingsTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	getFluentWebDriverWait().until(ExpectedConditions.visibilityOf(accounts));
    	accounts.click();
    ...
    public static boolean checkCloseBtnPreviewButtonBeforeLogout() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	Thread.sleep(2000);
    	getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(accountSettingsCloseBtn));
    	accountSettingsCloseBtn.click();
    ...
    public static boolean checkLogoutAfterCustomization() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
     ...
     public static boolean checkSettingsTabInPreviewOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
     {
		 ...
		 Thread.sleep(2000);
		 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(extraFields_SettingsTab));
		 extraFields_SettingsTab.click();
     ...
     public static boolean checkDetailsTabInPreviewOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
     {
		 ...
		 Thread.sleep(3000);
		 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(extraFields_DetailsTab));
		 extraFields_DetailsTab.click();
     ...
     public static boolean checkPrintLayoutTabInPreviewOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
     {
		 ...
		 Thread.sleep(2000);
		 getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(extraFields_PrintLayout));
		 extraFields_PrintLayout.click();
    ...
    public static boolean checkNewInCreateTab() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
    {
    	...
    	boolean actaddGroupCreateCreateTab_ExtraFieldUpdate  =extraFields_PreviewTab_CreateCreateTab_ExtraFieldUpdate.isDisplayed();
    	...
    	{ 
    		extraFields_PreviewTab_CreateCreateTab_ExtraFieldUpdate.click();
			 
    		extraFields_PreviewTab_CreateCreateTab_ExtraFieldUpdate.sendKeys("Test Extra Field Update");
	...
	public static boolean checkAccountDisplayInAccountGrid() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		Thread.sleep(2000);
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		String actList = accountslist.toString();
		 		String expList = "[]";
		 		System.out.println("Accounts In Account Master: " +accountslist);
		...
		int accountsCount = accontsNameList.size();
		 ...
		 ArrayList<String> accountslist = new ArrayList<String>();
		 		...
		 		for (int i = 0; i < accountsCount; i++)
		 		{
		 			 String data = accontsNameList.get(i).getText();
		 			accountslist.add(data);
		 			if(data.contains("Customer Group"))     
		 			{
	...
	public static boolean checkCloseAccountMaster() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		System.out.println("dashboardName                  : "+actlabelDashboard                 +" Value Expected : "+explabelDashboard);
		...
		if(dashboardName.isDisplayed() &&newAddDashBoard.isDisplayed() && dashboardCustomizationSettings.isDisplayed())
		{
			excelReader.setCellData(xlfile, "Sheet1", 406, 9, resPass);
			return true;
		}
	...
	/*	 			Thread.sleep(2000);
		...
		if(/*actMessage.equalsIgnoreCase(expMessage) && customerUpdateGroup == true*/true)
		{
			excelReader.setCellData(xlfile, "Sheet1", 407, 9, resPass);
			return true;
		}
	...
	public static boolean checkPropertiesOptionForAccount() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		Thread.sleep(2000);
		getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(accountPropertiesLabelTxt));
         
		boolean actaccountPropertiesLabelTxt    								=accountPropertiesLabelTxt.isDisplayed();
		...
		boolean actdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties  	=doNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties.isDisplayed();
		boolean actallowOtherCompaniesToViewRecordsCheckboxInAccountProperties               	=allowOtherCompaniesToViewRecordsCheckboxInAccountProperties.isDisplayed();
		...
		boolean expaccountPropertiesLabelTxt    								=true;
		...
		boolean expdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties  	=true;
		boolean expallowOtherCompaniesToViewRecordsCheckboxInAccountProperties               	=true;
		...
		System.out.println("accountPropertiesLabelTxt                                : "+actaccountPropertiesLabelTxt                                +" Value Expected : "+expaccountPropertiesLabelTxt);
		...
		System.out.println("doNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties : "+actdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties +" Value Expected : "+expdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties);
		System.out.println("allowOtherCompaniesToViewRecordsCheckboxInAccountProperties              : "+actallowOtherCompaniesToViewRecordsCheckboxInAccountProperties              +" Value Expected : "+expallowOtherCompaniesToViewRecordsCheckboxInAccountProperties);
		...
		if(actaccountPropertiesLabelTxt==expaccountPropertiesLabelTxt && actnormalRadioBtn==expnormalRadioBtn 
				...
				&& actdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties==expdoNotRestrictSelectionEvenIfRightsNotAllottedCheckboxInAccountProperties
				&& actallowOtherCompaniesToViewRecordsCheckboxInAccountProperties==expallowOtherCompaniesToViewRecordsCheckboxInAccountProperties
 	...
 	public static boolean checkSaveCOGSAccount() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 	  {
 	     ...
 	     System.out.println("********************* checkSaveCOGSAccount Method Executes.............   *****************************");
 	      ...
 	      /*  getFluentWebDriverWait().until(ExpectedConditions.elementToBeClickable(masterCreationNameOfLane1));
 			...
 			String actSaveAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			String actSaveBRAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			SaveBtn.click();
 	     	...
 	     	String actSaveFIFOAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			SaveBtn.click();
 	     	...
 	     	String actSaveWAAccountMessage = checkValidationMessage(expSaveMessage);
 	    	...
 	    	String actSaveSRATEAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			SaveBtn.click();
 	     	...
 	     	String actSaveSRAccountMessage = checkValidationMessage(expSaveMessage);
 	    	...
 	    	String actSaveSSAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			String actStockSaveAccountMessage = checkValidationMessage(expSaveMessage);
 			...
 			String expmasterGridBodyList="[EXCESS COGS POSTING ACC, EXCESS COGS POSTING ACC, Purchases, SHORTAGE COGS POSTING ACC, SHORTAGE COGS POSTING ACC, Purchases, SR COGS POSTING ACC, SR COGS POSTING ACC, Sales, STD RATE COGS ACC INV, STD RATE COGS ACC INV, Inventory, WA COGS ACC INV, WA COGS ACC INV, Inventory, FIFO COGS ACC INV, FIFO COGS ACC INV, Inventory, BR COGS ACC INV, BR COGS ACC INV, Inventory, COGS POSTING ACC, COGS POSTING ACC, Purchases, ASSETS, 001, Assets, EXPENSES, 009, Expenses, CONTROL ACCOUNTS, CA, Control, REVENUE, 007, Income, EQUITIES, 002, Liabilities, LIABILITIES, 003, Liabilities, Round off Exchange gain/ loss, RoundoffExgainloss, Income / Expense]";
 					/*excelReader.getCellData(xlSheetName, 120, 7);*/
 			...
 			System.out.println("COGS POSTING ACC Save Value Actual          : " + actSaveAccountMessage      + "  Value Expected : " + expSaveMessage);
 			System.out.println("BR COGS ACC INV ACC Save Value Actual       : " + actSaveBRAccountMessage    + "  Value Expected : " + expSaveMessage);
 			System.out.println("FIFO COGS ACC INV ACC Save Value Actual     : " + actSaveFIFOAccountMessage  + "  Value Expected : " + expSaveMessage);
 			System.out.println("WA COGS ACC INV ACC Save Value Actual       : " + actSaveWAAccountMessage    + "  Value Expected : " + expSaveMessage);
 			System.out.println("STD RATE COGS ACC INV ACC Save Value Actual : " + actSaveSRATEAccountMessage + "  Value Expected : " + expSaveMessage);
 			System.out.println("SR COGS POSTING ACC Save Value Actual       : " + actSaveSRAccountMessage    + "  Value Expected : " + expSaveMessage);
 			System.out.println("SHORTAGE COGS POSTING ACC Save Value Actual : " + actSaveSSAccountMessage    + "  Value Expected : " + expSaveMessage);
 			System.out.println("Stock Value Actual                          : " + actStockSaveAccountMessage + "  Value Expected : " + expSaveMessage);
 			
 			if (actStockSaveAccountMessage.equalsIgnoreCase(expSaveMessage) && actmasterGridBodyList.equalsIgnoreCase(expmasterGridBodyList)) 
 			{
 	 ...
 	 try
 	  ...
 	  public static boolean checkSaveAccountsByCreatingVATAccounts() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 	  {
 	     ...
 	     try
 	     {
 			...
 			String actSavePVAccountMessage = checkValidationMessage(expSaveMessage);
 		...
 		int masterGridBodyListCount=masterGridBodyRowCount.size();
 			...
 			System.out.println("masterGridBodyList Actual              : " +actmasterGridBodyList);
 			System.out.println("masterGridBodyList Expected            : " +expmasterGridBodyList);
 			System.out.println("VAT OUTPUT ACC Save Value Actual       : " + actSaveAccountMessage     + "  Value Expected : " + expSaveMessage);
 			System.out.println("VAT ADVANCE SALE ACC Save Value Actual : " + actSaveBRAccountMessage   + "  Value Expected : " + expSaveMessage);
 			System.out.println("VAT ADVANCE PURCHASE Save Value Actual : " + actSaveFIFOAccountMessage + "  Value Expected : " + expSaveMessage);
 			
 			if (actSaveAccountMessage.equalsIgnoreCase(expSaveMessage) && actmasterGridBodyList.equalsIgnoreCase(expmasterGridBodyList)) 
 			{
