...
public class DebitNotesVatPage extends BaseEngine
{
...
private static WebElement  salesAccount_SettingsBtn;
	...
	@FindBy(xpath="//input[@id='id_header_67108946']")
   ...
   @FindBy(xpath="//*[@id='id_transaction_entry_detail_table_body']/tr[3]/td[12]")
	...
	@FindBy(xpath="//input[@id='id_body_16777317']")
...
*/
 ...
 public boolean checkEntryPageDeleteMessage() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
 {
	...
	*/
	...
	public boolean checkSavingVoucherWithCustomerInDebitnotes() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
		...
		*/
		...
		for (int i = 0; i <billwiseAdjustBillsDocListcount; i++) 
		{
			...
			if (data.equalsIgnoreCase("NDT48:SU/AME/TEXT1")) 
			{
				...
				System.err.println(" Selecting Voucher-------------   NDT52:1");
    ...
    public boolean checkSavingVoucherInDebitNotesWithNewReferencethroughCopyToCLipboard() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
	{
...
public boolean checkSuspendingVoucherInDebitNotesVAT() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
{
	...
	String expSuspendStatusR1="true";
...
public boolean checkDeleteOption() throws EncryptedDocumentException, InvalidFormatException, IOException, InterruptedException
{
...
public boolean checkSignOut() throws InterruptedException, EncryptedDocumentException, InvalidFormatException, IOException
{
	excelReader=new ExcelReader(POJOUtility.getExcelPath());
	xlfile=getBaseDir()+"\\src\\main\\resources\\testdata\\FocusTestData.xlsx";
	...
	catch (Exception e) 
	{
		...
		return false;
		  ...
		  public DebitNotesVatPage(WebDriver driver)
		  {
